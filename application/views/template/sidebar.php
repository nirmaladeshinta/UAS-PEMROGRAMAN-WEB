         ...
         <ul
             ...
             <li class="nav-item">
                 ...
                 <ul class="nav nav-treeview">
                     <li class="nav-item">
                         <a href="<?= base_url('index.php/welcome/supplier');  ?>" class="nav-link">
                             <i class="nav-icon bi bi-circle"></i>
                             <p>Supplier</p>
                         </a>
                     </li>
                     <li class="nav-item">
                         <a href="<?= base_url('index.php/welcome/jenis_barang');  ?>" class="nav-link">
                             <i class="nav-icon bi bi-circle"></i>
                             <p>Jenis Barang</p>
                         </a>
                     </li>
                     <li class="nav-item">
                         <a href="<?= base_url('index.php/welcome/barang'); ?>" class="nav-link">
                             <i class="nav-icon bi bi-circle"></i>
                             <p>Data Barang</p>
                         </a>
                     </li>
             ...
             <li class="nav-item">
                 ...
                 <ul class="nav nav-treeview">
                     <li class="nav-item">
                         <a href="<?= base_url('index.php/kelas2b/Jenisbayar');  ?>" class="nav-link">
                             <i class="nav-icon bi bi-circle"></i>
             ...
             <li class="nav-item">
                 ...
                 <ul class="nav nav-treeview">
                     <li class="nav-item">
                         <a href="<?= base_url('index.php/welcome/Session_form'); ?>" class="nav-link">
                             <i class="nav-icon bi bi-circle"></i>
                             <p>Contoh session 1</p>
                         </a>
                     </li>
                 </ul>
             </li>
